...
export const Operations = {
  ...
  PATIENT_PAYMENT_PUT: new Operation(
    Resource.PATIENT_PAYMENT,
    Action.PUT_PATIENT_PAYMENT,
  ),
  PATIENT_PAYMENT_DELETE: new Operation(
    Resource.PATIENT_PAYMENT,
    Action.DELETE_PATIENT_PAYMENT,
  ),

  // Medical service operations
  MEDICAL_SERVICE_CREATE: new Operation(
    Resource.MEDICAL_SERVICE,
    Action.CREATE,
  ),
  MEDICAL_SERVICE_READ: new Operation(Resource.MEDICAL_SERVICE, Action.READ),
  MEDICAL_SERVICE_UPDATE: new Operation(
    Resource.MEDICAL_SERVICE,
    Action.UPDATE,
  ),
  MEDICAL_SERVICE_DELETE: new Operation(
    Resource.MEDICAL_SERVICE,
    Action.DELETE,
  ),
  MEDICAL_SERVICE_MANAGE: new Operation(
    Resource.MEDICAL_SERVICE,
    Action.MANAGE,
  ),
  MEDICAL_SERVICE_SET_STATUS: new Operation(
    Resource.MEDICAL_SERVICE_STATUS,
    Action.SET_MEDICAL_SERVICE_STATUS,
  ),
  MEDICAL_SERVICE_SET_FEES: new Operation(
  ...
  MEDICAL_HISTORY_CREATE: new Operation(
    Resource.MEDICAL_HISTORY,
    Action.CREATE,
  ),
  MEDICAL_HISTORY_READ: new Operation(Resource.MEDICAL_HISTORY, Action.READ),
  MEDICAL_HISTORY_UPDATE: new Operation(
    Resource.MEDICAL_HISTORY,
    Action.UPDATE,
  ),

  // Document operations
  UPLOADED_DOCUMENT_CREATE: new Operation(
    Resource.UPLOADED_DOCUMENT,
    Action.CREATE,
  ),
  UPLOADED_DOCUMENT_READ: new Operation(
    Resource.UPLOADED_DOCUMENT,
    Action.READ,
  ),
  UPLOADED_DOCUMENT_DELETE: new Operation(
    Resource.UPLOADED_DOCUMENT,
    Action.DELETE,
  ),
  GENERATED_DOCUMENT_CREATE: new Operation(
    Resource.GENERATED_DOCUMENT,
    Action.CREATE,
  ),
  GENERATED_DOCUMENT_READ: new Operation(
    Resource.GENERATED_DOCUMENT,
    Action.READ,
  ),
